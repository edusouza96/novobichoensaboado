            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="observation" id="observation" class="form-control" cols="30" rows="3" v-model="observation"></textarea>
                </div>
              </div>
            </div>
        </div>
...
export default {
  ...
  computed: {
    disabledConfirm() {
      return (this.source == "" || this.valueWithdraw == "0,00" || this.observation == "");
    }
  },
  methods: {
    confirm() {
