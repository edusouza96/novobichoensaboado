@extends('layout.page') 
@section('title') Relatório - Pets atendidos por Raça @endsection
            ...
            <form method="GET">
                <div class="card">
                    ...
                    <div class="card-footer filter-footer">
                        <a href="{{route('report.petsAttendedByBreed')}}" class="btn btn-secondary">
                ...
                <div class="container">
                    <div class="mt-4 row justify-content-end">
                        <div class="col-2 text-right">
                            <a href="{{route('report.petsAttendedByBreedExcel', request()->input())}}" class="btn btn-success" type="submit">
                                <i class="fas fa-file-excel"></i> Gerar Planilha
                            </a>
                        </div>
                        
                        <div class="col-2 text-right">
                            <modal-chart-pie title="Atendimentos por raça" route="report.petsAttendedByBreedChart" :param="param"></modal-chart-pie>
